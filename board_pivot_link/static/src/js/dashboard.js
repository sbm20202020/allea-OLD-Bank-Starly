...
FormRenderer.include({
    events: _.extend({}, FormRenderer.prototype.events, {
        ...
        'click .oe_dashboard_column .oe_open': '_onOpenAction',
    }),
            ...
            .then(function (action) {
                ...
                return self.loadViews(action.res_model, params.context, [view])
                    ...
                    var view = new View(viewInfo, {
                        ...
                        hasSelectors: false,
                        boardControllerID: params.boardControllerID,
                    });
    ...
    _onOpenAction: function (event){
        event.stopPropagation();
        let boardAction = this.actionsDescr[$(event.currentTarget).closest('div').data('id')];
        let controller = _.findWhere(this._boardSubcontrollers, {boardControllerID: boardAction.id});
        if (controller) {
            controller._downloadTable();
        }
    },
    /**
     * @private
